...
public class Activator implements BundleActivator {
  ...
  public void start( BundleContext context ) throws Exception {
    securityContextProviderServiceRegistration = context.registerService( SecurityContextProvider.class,
                                                                          new SecurityContextProviderComponent(),
                                                                          null );
    rolesAllowedDynamicFeatureProviderServiceRegistration = context.registerService( RolesAllowedDynamicFeatureProvider.class,
                                                                                     new RolesAllowedDynamicFeatureProvider(),
                                                                                     null );
    authenticationServiceTracker = new ServiceTracker<AuthenticationService, AuthenticationService>( context,
                                                                                                     AuthenticationService.class,
                                                                                                     null );
    authenticationServiceTracker.open();
    authorizationServiceTracker = new ServiceTracker<AuthorizationService, AuthorizationService>( context,
