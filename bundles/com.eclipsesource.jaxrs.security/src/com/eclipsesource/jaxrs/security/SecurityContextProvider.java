...
/**
 * This is an OSGi service interface for providing a security context for accesses to a RESTful
 * service.
 * 
 */
public interface SecurityContextProvider {
  ...
  /**
   * @param requestContext the request context for the incoming RESTful request
