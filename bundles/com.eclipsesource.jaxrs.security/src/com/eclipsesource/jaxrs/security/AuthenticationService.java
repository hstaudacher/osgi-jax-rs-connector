...
/**
 * This is an OSGi service interface for authenticating users requesting access to a RESTful
 * service.
 * 
 */
public interface AuthenticationService {
  ...
  /**
   * Authenticates the user initiating the RESTful request. Implementations must return null if the
   * user could not be authenticated.
   * 
   * @param requestContext the request context supplied by Jersey
   * @return a principal representing the authenticated user initiating the RESTful request; null if
